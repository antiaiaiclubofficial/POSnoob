            ...
            {currentUser ? (
              ...
              <div className="space-y-6 text-center">
                ...
                <button 
                  ...
                  className="w-full bg-[#0d0e15] hover:bg-gradient-to-r hover:from-[#4285F4] hover:via-[#EA4335] hover:to-[#34A853] hover:border-transparent text-white border border-[#3a3f50] font-bold py-5 rounded-full flex items-center justify-center gap-3 shadow-xl transition-all active:scale-95"
                >
