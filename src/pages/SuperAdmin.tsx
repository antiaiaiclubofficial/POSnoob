            ...
            {currentUser ? (
              ...
              <div className="space-y-6 text-center">
                ...
                <button 
                  ...
                  className="w-full bg-[#0d0e15] hover:bg-[#151722] text-white border border-[#3a3f50] font-bold py-5 rounded-full flex items-center justify-center gap-3 shadow-xl transition-all active:scale-95"
                >
