...
Now let's update `src/store/useStore.ts` to initialize `rolePermissions` with sensible defaults and implement `updateRolePermissions`.

<dyad-write path="src/store/useStore.ts" description="Implementing rolePermissions and updateRolePermissions in the store.">
