...
Now, let's update `src/App.tsx` to load `max_staff` into `maxStaff` when fetching store settings.

<dyad-write path="src/App.tsx" description="Loading max_staff into maxStaff in App.tsx">
"use client";
