...
export const translations = {
  en: {
    ...
    membershipDesc: "Define conditions and segment customers to offer privileges",
    publicLabel: "Label",
  ...
  th: {
    ...
    membershipDesc: "กำหนดเงื่อนไขและแบ่งกลุ่มลูกค้าตามยอดใช้จ่ายเพื่อมอบสิทธิพิเศษต่างๆ",
