...
export const COLOR_MAP = {
  ...
  blue: {
    ...
    border: "border-[#bac4f5]",
    dot: "bg-[#020d35]",
    badge: "bg-[#dce1ff] text-[#0d193f]"
  },
  pink: {
  ...
  green: {
    ...
    border: "border-[#bed041]",
    dot: "bg-[#1a1e00]",
    badge: "bg-[#daed5b] text-[#1a1e00]"
  },
  purple: {
    bg: "bg-[#d9d6fe] text-[#191836] hover:bg-[#c5c3ea]",
    border: "border-[#c5c3ea]",
    dot: "bg-[#191836]",
    badge: "bg-[#d9d6fe] text-[#191836]"
  },
  amber: {
    bg: "bg-[#FBE8E8] text-[#8E171D] hover:bg-[#F3C2C2]",
    border: "border-[#F3C2C2]",
    dot: "bg-[#8E171D]",
    badge: "bg-[#FBE8E8] text-[#8E171D]"
  }
};
