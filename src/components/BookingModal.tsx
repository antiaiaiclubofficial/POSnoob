                ...
                <div className="flex justify-center">
                  <DayPicker
                    ...
                    classNames={{
                      ...
                      head_cell: "text-gray-300 w-9 font-black text-[9px] uppercase text-center",
                      row: "flex w-full justify-center mt-1",
                      cell: "relative p-0 text-center text-sm focus-within:relative focus-within:z-20 w-9",
                      day: "h-9 w-9 p-0 font-bold rounded-xl transition-all hover:bg-gray-50 flex items-center justify-center mx-auto",
